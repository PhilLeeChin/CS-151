// CS.151.060.Philip.Lee-Chin.Lab.2.4.cpp : Defines the entry point for the console application.
...
int main()
{
	...
	topChoiceTotal = 148;
		// Fill in the blanks of the following to print the appropriate values :
